...
(function($) {
	...
	$.jPlayer.prototype = {
		...
		jPlayerOnProgressChange: function(lp, ppr, ppa, pt, tt, tb) { // Called from Flash / HTML5 interval
			...
			this.config.diag.totalBytes = tb;
			...
			this.onProgressChangeCustom(lp, ppr, ppa, pt, tt, tb);
			this._forceUpdate();
		},
